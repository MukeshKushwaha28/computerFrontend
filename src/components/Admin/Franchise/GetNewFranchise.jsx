    ...
    const findfranchise = async () => {
        try {
          ...
          const franchise = await axios.get(
            "https://computerbackend-1.onrender.com/api/admin/get-new-franchise-requests"
          );
      ...
      const updatefranchise = async(id)=>{
        try {
          ...
          const franchise = await axios.get(`https://computerbackend-1.onrender.com/api/admin/verify-franchise/${id}`)
